...
(cl:defmethod cl:initialize-instance :after ((m <AddInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sean_ros-srv:<AddInts-request> is deprecated: use sean_ros-srv:AddInts-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <AddInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sean_ros-srv:num1-val is deprecated.  Use sean_ros-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <AddInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sean_ros-srv:num2-val is deprecated.  Use sean_ros-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod cl:initialize-instance :after ((m <AddInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sean_ros-srv:<AddInts-response> is deprecated: use sean_ros-srv:AddInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <AddInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sean_ros-srv:sum-val is deprecated.  Use sean_ros-srv:sum instead.")
  (sum m))
